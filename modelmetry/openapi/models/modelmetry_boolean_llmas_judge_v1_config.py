...
class ModelmetryBooleanLLMAsJudgeV1Config(BaseModel):
    """
    ModelmetryBooleanLLMAsJudgeV1Config
    """ # noqa: E501
    finding_name: StrictStr = Field(description="The name of the finding to use for this evaluator's boolean output (e.g., is_threatening, is_about_hotels).", alias="FindingName")
    instructions: Annotated[str, Field(min_length=1, strict=True)] = Field(description="You are an LLM evaluator. We need the guarantee that the output answers what is being asked on the input, please evaluate as False if it doesn't.", alias="Instructions")
