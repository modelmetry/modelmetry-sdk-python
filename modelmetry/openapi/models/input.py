...
class Input(BaseModel):
    ...
    Input
    """ # noqa: E501
    chat: Optional[ChatInput] = Field(default=None, alias="Chat")
    text: Optional[TextInput] = Field(default=None, alias="Text")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Chat": ChatInput.from_dict(obj["Chat"]) if obj.get("Chat") is not None else None,
            "Text": TextInput.from_dict(obj["Text"]) if obj.get("Text") is not None else None
        })
        return _obj
